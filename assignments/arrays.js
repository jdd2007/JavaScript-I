...
console.log('Answer to Arrays Ch 1');
...
console.log('Answer to Arrays Ch 2');
console.log('The make and model of the last car: ', inventory[inventory.length - 1]['car_make'], ' ', inventory[inventory.length - 1]['car_model']);
...
// fruits.push("Kiwi");  <---- model push on fruits array

for (let i = 0; i < inventory.length; i++) {
    carModels.push(inventory[i].car_model)
};
console.log('Answer to Arrays Ch 3');
...
console.log('Answer to Arrays Ch 4');
...
console.log('Answer to Arrays Ch 5');
...
let BMWAndAudiString = JSON.stringify(BMWAndAudi);

console.log('Answer to Arrays Ch 6');
